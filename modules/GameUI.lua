...
"•  Status: No Results\n" ..
"•  Database: Game May Not Be Available\n" ..
...
table.insert(list, "B A C K")
local c = gg.choice(list, nil, " Search Result:")
...
"•  YouTube: https://www.youtube.com/@S4FUNGG\n" ..
...
"•  Telegram Channel: https://t.me/ScriptForFun\n" ..
"•  YouTube: https://www.youtube.com/@S4FUNGG\n\n" ..
" If your question is not listed above, please contact support for further assistance.",
"B A C K"
)
mainMenu()
end
